...
describe('projectPortfolio', () => {
  ...
  it('returns one entry per projected year', () => {
    const result = projectPortfolio(50000, targets, assumptions, 0, 0);
  ...
  it('contributions accumulate over time', () => {
    const result = projectPortfolio(50000, targets, assumptions, 6000, 0);
  ...
  it('reports independence year when spending target is reachable', () => {
    ...
    const result = projectPortfolio(600000, targets, assumptions, 12000, 24000);
  ...
  it('reports null independence when spending is too high', () => {
    const result = projectPortfolio(50000, targets, assumptions, 0, 100000);
